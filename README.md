...
기능적 요구사항
1. 관리자가 도서를 등록한다.
1. 사용자가 도서를 대여 신청(예약)한다.
1. 사용자가 도서를 대여한다.
1. 사용자가 도서를 반납한다.
1. 사용자가 예약을 취소할 수 있다.
1. 사용자가 예약도서의 상태를 조회한다.
1. 도서대출 상태가 바뀔떄마다 카톡으로 알림을 보낸다.

비기능적 요구사항
1. 트랜잭션
    1. 예약이 되지 않은 경우 대여가 되지 않아야 한다  Sync 호출 
1. 장애격리
...
1. 성능
    1. 사용자가 예약또는 대출한 도서 목록을 확인하여 해당 도서의 상태를 확인할 수 있어야 한다. CQRS
    1. 도서대출 상태가 변경될 때마다 카톡 등으로 알림을 줄 수 있어야 한다  Event driven
