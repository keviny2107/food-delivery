...
1. 사용자가 도서를 반납한다.
1. 사용자가 예약을 취소할 수 있다.
1. 사용자가 예약 도서의 상태를 조회한다.
1. 도서 대여 상태가 바뀔때마다 사용자에게 카톡으로 알림을 보낸다.
...
1. 성능
    1. 사용자는 전체 도서의 목록 및 상태를 확인할 수 있어야한다 CQRS
    1. 사용자는 본인 대여 도서의 목록 및 상태를 확인할 수 있어야한다 CQRS
    1. 도서 대여 상태가 변경될 때마다 사용자에게 카톡 등으로 알림을 줄 수 있어야 한다  Event driven
